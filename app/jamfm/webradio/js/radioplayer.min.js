...
var radioplayer={consts:{consolelog:!1,is_iOS:!1,is_Android:!1,reduced_func:!1,user:null,assetBaseUrl:"",force_reduced_func:!1,show_cookie_dependent_features:!0,show_cookie_anno:!1,show_cookie_consent:!0,cookie_consent_required:!0,cookie_anno_ttl:31536E4,api:{stationList:"http://static.radioplayer.de/v1/json/StationList.js",init:"http://cookie.radioplayer.de/cm/",search:"http://search.radioplayer.de/qp/v3/search",suggest:"http://search.radioplayer.de/qp/v3/suggest",onAir:"http://search.radioplayer.de/qp/v3/onair",
pollOnAir:"http://np.radioplayer.de/qp/v3/onair",onDemand:"http://search.radioplayer.de/qp/v3/oditem",recommend:"http://search.radioplayer.de/qp/v3/recommend",az:"http://search.radioplayer.de/qp/v3/stations"},iframe:{analytics:"http://static.radioplayer.de/v3/analytics.html"}},services:{},emp:{},controls:{},playing:{},overlay:{},mystations:{},history:{},search:{},lang:{},utils:{},settings:{lastplayed:currentStationID,presets:[],history:[],stationlistprefix:"",guid:""},stnList:{},querystring:{},initFailTimeout:null,
checkCookieConsentFailTimeout:null,startAtSeconds:0,themeColour:"dark",mouseActive:!1,objs:{body:null,searchBox:null,searchInput:null,overlayContainer:null,stickyLetterDivide:null,suggestContainer:null,searchContainer:null,searchKeywords:null,searchResults:null,searchAllContainer:null,searchLiveContainer:null,searchODContainer:null,nowPlayingStrip:null,scrollingContainer:null,scrollingText:null},init:function(){user=detect.parse(navigator.userAgent);radioplayer.consts.is_iOS=/(iOS)/.test(user.os.family);
radioplayer.consts.is_Android=/Android/.test(user.os.family);window.force_reduced_func&&(radioplayer.consts.force_reduced_func=!0);radioplayer.consts.force_reduced_func&&(radioplayer.consts.reduced_func=!0);/(Safari)/.test(user.browser.family)&&(radioplayer.consts.reduced_func=!0);$(".radioplayer-globalnav .rp-logo").html(radioplayer.lang.general.radioplayer);$(".radioplayer-globalnav .menu-btn").attr("title",radioplayer.lang.general.open_menu).find("span").html(radioplayer.lang.general.open_menu);
$("#toggle-mystations").attr("title",radioplayer.lang.mystations.add_this).find("span").html(radioplayer.lang.mystations.add_this);radioplayer.querystring=radioplayer.utils.getQueryStringObj();$(".radioplayer").hasClass("light-theme")&&(radioplayer.consts.themeColour="light");radioplayer.objs.body=$("body");radioplayer.querystring.rpAodUrl&&(audioLive=!1,audioFlash=audioHTML=[{audioType:"http",audioUrl:radioplayer.querystring.rpAodUrl}],nowPlayingSource="OD");radioplayer.querystring.t&&!audioLive&&
(radioplayer.startAtSeconds=radioplayer.utils.convertTimeToSeconds(radioplayer.querystring.t),radioplayer.utils.output("start at "+radioplayer.startAtSeconds+" seconds into OD audio"),$(radioplayer.emp).on("loaded",function(){0<radioplayer.startAtSeconds&&radioplayer.startAtSeconds<=radioplayer.controls.rawDuration/1E3&&(radioplayer.emp.seek(radioplayer.startAtSeconds),radioplayer.startAtSeconds=0)}));radioplayer.controls.init();radioplayer.mystations.init();audioLive?radioplayer.playing.init():radioplayer.services.getAPI(radioplayer.consts.api.onDemand+
"?odUrl\x3d"+encodeURIComponent(document.location.href)+"\x26nameSize\x3d200\x26descriptionSize\x3d200\x26callback\x3dradioplayer.playing.receiveOD");radioplayer.overlay.init();radioplayer.search.init();/(Safari)/.test(user.browser.family)&&radioplayer.services.hideCookieDependentFeatures();/(Desktop)/.test(user.device.type)&&$("html, body").addClass("desktop");radioplayer.services.analytics.init();$(document).on("mousedown",function(){radioplayer.mouseActive||(radioplayer.mouseActive=!0,radioplayer.objs.body.addClass("rp-mouseactivity"))}).on("keydown",
function(){radioplayer.mouseActive&&(radioplayer.mouseActive=!1,radioplayer.objs.body.removeClass("rp-mouseactivity"))});radioplayer.controls.resizeProgressScrubber();$(window).resize(function(){radioplayer.controls.resizeProgressScrubber();$.browser.msie&&7==$.browser.version||radioplayer.overlay.resizeStickyDivide();radioplayer.overlay.resetNavigationMenu();radioplayer.search.resetNavigationMenu()});$(".radioplayer-plugin").on("click","a[data-newstationid]",function(){var a=$(this).attr("data-newstationid"),
b=$(this).attr("href");radioplayer.overlay.sidewaysNavigate("Plugin Space",a,b)});radioplayer.initFailTimeout=setTimeout(function(){radioplayer.controls.isPlaying||(radioplayer.emp.setAudioParams(window.audioFlash,window.audioHTML,window.audioLive,window.bufferTime,window.preferHtml5Audio),radioplayer.emp.dataReady())},5E3);radioplayer.services.checkCookieConsent(function(){radioplayer.consts.show_cookie_consent&&(radioplayer.consts.reduced_func=!0);radioplayer.services.initCookie()});radioplayer.services.getAPI(radioplayer.consts.api.stationList);
$("html").addClass("rp-js")}};Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){for(var c=b||0,e=this.length;c<e;c++)if(this[c]===a)return c;return-1});
...
(radioplayer.consts.reduced_func=!1));radioplayer.consts.show_cookie_consent?radioplayer.services.showCookieConsent():(-1==document.cookie.indexOf("rp-accepted-cookie-consent")&&(document.cookie="rp-accepted-cookie-consent\x3dyes;max-age\x3d"+radioplayer.consts.cookie_anno_ttl),radioplayer.consts.show_cookie_anno&&-1==document.cookie.indexOf("rp-seen-cookie-anno")&&radioplayer.services.showCookieAnno())},initCookie:function(){var a="?callback\x3dradioplayer.services.receiveInit";radioplayer.querystring.stationlistprefix&&
...
"announcement","true");$(".radioplayer-anno").animate({top:"-900px"},600,function(){if(0<radioplayer.services.queuedAnnos.length){var a=radioplayer.services.queuedAnnos.shift();radioplayer.services.showAnno(a,!0)}else $(this).remove()})},showCookieAnno:function(){-1!=document.cookie.indexOf("rp-seen-cookie-anno")&&(document.cookie="rp-seen-cookie-anno\x3dyes;max-age\x3d"+radioplayer.consts.cookie_anno_ttl);radioplayer.services.showAnno(radioplayer.lang.general.cookie_anno,!1,!0)},queueAnno:function(a){radioplayer.services.queuedAnnos.push(a)},
hideCookieConsent:function(){radioplayer.consts.show_cookie_consent=!1;radioplayer.consts.force_reduced_func||/(Safari)/.test(user.browser.family)||(radioplayer.consts.reduced_func=!1);-1==document.cookie.indexOf("rp-accepted-cookie-consent")&&(document.cookie="rp-accepted-cookie-consent\x3dyes;max-age\x3d"+radioplayer.consts.cookie_anno_ttl);radioplayer.services.saveCookie("cookie-consent/s","accepted-cookie-consent","true",function(){radioplayer.services.initCookie()});$(".radioplayer-cookie-consent").animate({top:"-900px"},
600,function(){$(this).remove();radioplayer.consts.show_cookie_anno&&-1==document.cookie.indexOf("rp-seen-cookie-anno")&&radioplayer.services.showCookieAnno()})},showCookieConsent:function(){/(Safari)/.test(user.browser.family)?radioplayer.services.showAnno(radioplayer.lang.general.reduced_func_anno):($(".radioplayer").append('\x3cdiv class\x3d"radioplayer-cookie-consent"\x3e\x3ca href\x3d"#" class\x3d"cookie-consent-button"\x3e'+radioplayer.lang.general.cookie_consent_dismiss+'\x3c/a\x3e\x3cdiv class\x3d"cookie-consent-text"\x3e'+
...
scale:"noScale",allowFullscreen:"false",allowScriptAccess:"always",bgcolor:"0x000000"},e,function(a){0==a.success&&c.$api.trigger(c.api.event.noSupport,c.getEventObject())})},dataReady:function(){this.api.DEBUG&&radioplayer.utils.output("flash: Try to initialize the EMP SWF, if it is ready");this.ready?(this.api.DEBUG&&radioplayer.utils.output("flash: EMP SWF ALREADY READY"),this.passParamsToEMP()):(this.api.DEBUG&&radioplayer.utils.output("flash: EMP SWF NOT READY"),this.waitingForReady=!0)},empReady:function(){this.api.DEBUG&&
radioplayer.utils.output("flash: EMP SWF REPORTS READY");this.ready=!0;this.api.ready=!0;this.empswf=document.getElementById(this.swfname);this.respondToEmp("empReady");this.waitingForReady&&(this.waitingForReady=!1,this.api.DEBUG&&radioplayer.utils.output("flash: EMP SWF is now ready to begin receiving parameters"),this.passParamsToEMP())},setParams:function(a,b,c,e,d,g){this.audioType=a;this.audioUrl=b;this.audioServer=c;this.audioEndpoint=e;this.audioLive=d;this.bufferTime=g},setAudioParams:function(a,
b,c){this.audioFlash=a&&a.length?a:[];this.audioLive=b;this.bufferTime=c},passParamsToEMP:function(){this.api.DEBUG&&this.empswf.emp_setDebugMode(!0);this.api.DEBUG&&radioplayer.utils.output("flash: Passing parameters to EMP SWF object");this.audioFlash[0].hasOwnProperty("cacheKiller")&&(radioplayer.utils.output("Set cache killer to: "+(this.audioFlash[0].cacheKiller?"true":"false")),this.empswf.emp_setUseCacheKiller(this.audioFlash[0].cacheKiller));this.audioFlash[0].hasOwnProperty("appendVersion")&&
(radioplayer.utils.output("Set appendVersion to: "+(this.audioFlash[0].appendVersion?"true":"false")),this.empswf.emp_setAppendVersionToUrl(this.audioFlash[0].appendVersion));this.audioFlash.length?this.setAudio(this.audioFlash):"rtmp"===this.audioType?this.loadRTMPStream(this.audioServer,this.audioEndpoint):"http"===this.audioType?this.loadHTTPStream(this.audioUrl):"httpmp4m4a"===this.audioType||"httpaac"===this.audioType?this.loadHTTPMP4M4AStream(this.audioUrl):"playlist"===this.audioType?this.loadPlaylist(this.audioUrl):
this.$api.trigger(this.api.event.noSupport,this.getEventObject());this.setPlaybackMode(this.audioLive?"live":"od");this.setVolume(radioplayer.controls.currentVolume);this.empswf.emp_setBufferTime(this.bufferTime)},setAudio:function(a){this.cleanup();this.audioFlash=a&&a.length?a:[];(a=this.audioFlash.length?this.audioFlash[0]:!1)?this.passSetAudio(a):this.$api.trigger(this.api.event.noSupport,this.getEventObject())},passSetAudio:function(a){"rtmp"===a.audioType?this.loadRTMPStream(a.audioServer,a.audioEndpoint):
...
$(".search-container .tabs #search-nav-main li").eq(1).find("a span").html(radioplayer.lang.search.tab_live);$(".search-container .tabs #search-nav-main li").eq(2).find("a span").html(radioplayer.lang.search.tab_catchup);$("#search-nav-toggle").click(function(a){a.preventDefault();radioplayer.search.hideShowNavigationMenu()});radioplayer.objs.searchInput.on("focus click",function(){$(".radioplayer-globalnav .rp-logo").addClass("reduced");radioplayer.objs.searchBox.addClass("focus");radioplayer.objs.searchInput.val()!=
radioplayer.lang.search.search_radioplayer||radioplayer.objs.searchBox.hasClass("active")?""!=radioplayer.objs.searchInput.val()&&radioplayer.objs.searchBox.hasClass("active")&&0<radioplayer.objs.suggestContainer.data("results")&&!radioplayer.objs.body.hasClass("showing-overlay")&&(radioplayer.overlay.show(radioplayer.lang.general.close_search),radioplayer.objs.body.addClass("showing-suggest"),radioplayer.search.lastSuggestQ!=radioplayer.objs.searchInput.val()&&radioplayer.search.execSuggest()):(radioplayer.objs.searchInput.val("").enableSelection(),
radioplayer.utils.setCaretToPos(document.getElementById("search-input"),0))}).on("blur",function(){$(".radioplayer-globalnav .rp-logo").removeClass("reduced");radioplayer.objs.searchBox.removeClass("focus");radioplayer.objs.searchBox.hasClass("active")&&""==radioplayer.objs.searchInput.val()?radioplayer.objs.body.hasClass("showing-suggest")?radioplayer.search.clearAndCloseSuggestResults():radioplayer.search.resetSearchInput():""==radioplayer.objs.searchInput.val()&&radioplayer.objs.searchInput.val(radioplayer.lang.search.search_radioplayer)}).on("keydown",
function(a){9!=a.which&&(radioplayer.objs.searchBox.hasClass("active")?""===radioplayer.objs.searchInput.val()||radioplayer.objs.body.hasClass("showing-search")||radioplayer.objs.body.hasClass("showing-suggest")||(radioplayer.overlay.show(radioplayer.lang.general.close_search),radioplayer.objs.body.addClass("showing-suggest")):-1!==$.inArray(a.which,[8,13,16,17,18,19,20,27,32,35,36,37,38,39,40,46,91,93,224])?a.preventDefault():(radioplayer.objs.searchBox.addClass("active"),radioplayer.objs.body.hasClass("showing-search")||
radioplayer.objs.body.hasClass("showing-suggest")||(radioplayer.overlay.show(radioplayer.lang.general.close_search),radioplayer.objs.body.addClass("showing-suggest"))))}).on("keyup",function(a){radioplayer.overlay.resetInactivity();var b=radioplayer.objs.suggestContainer;38==a.which&&radioplayer.objs.body.hasClass("showing-suggest")?0==b.find(".suggest-item.on").length?b.find(".suggest-item:last").addClass("on kb-focus"):(a=b.find(".suggest-item").index(b.find(".suggest-item.on")),b.find(".suggest-item.on").removeClass("on kb-focus"),
b.find(".suggest-item").eq(a-1).addClass("on kb-focus")):40==a.which&&radioplayer.objs.body.hasClass("showing-suggest")?0==b.find(".suggest-item.on").length?b.find(".suggest-item:first").addClass("on kb-focus"):b.find(".suggest-item:last").hasClass("on")?(b.find(".suggest-item:last").removeClass("on kb-focus"),b.find(".suggest-item:first").addClass("on kb-focus")):(a=b.find(".suggest-item").index(b.find(".suggest-item.on")),b.find(".suggest-item.on").removeClass("on kb-focus"),b.find(".suggest-item").eq(a+
1).addClass("on kb-focus")):13==a.which?radioplayer.objs.body.hasClass("showing-suggest")?(b=b.find(".suggest-item.on.kb-focus"),1==b.length?b.hasClass("show-all")?(radioplayer.search.execFull(),radioplayer.search.hideNavigationMenu()):(b=b.find("a").attr("href"),window.location.href=b):(radioplayer.search.execFull(),radioplayer.search.hideNavigationMenu())):radioplayer.objs.body.hasClass("showing-search")&&(radioplayer.search.execFull(),radioplayer.search.hideNavigationMenu()):-1==$.inArray(a.which,
[9,13,16,17,18,19,20,27,35,36,37,38,39,40,91,93,224])&&($("#search-clear").hide(),$("#search-button").show(),radioplayer.objs.body.hasClass("showing-suggest")?(b.find(".suggest-item.show-all").removeClass("on kb-focus"),""==radioplayer.objs.searchInput.val()?radioplayer.search.clearAndCloseSuggestResults():radioplayer.search.execSuggest()):""==radioplayer.objs.searchInput.val()&&radioplayer.search.resetSearchInput())}).disableSelection();radioplayer.objs.suggestContainer.on("click",".suggest-item.show-all a",
function(a){a.preventDefault();radioplayer.search.execFull();radioplayer.search.hideNavigationMenu()}).on("click","#suggest-results .suggest-item a",function(a){a.preventDefault();a=$(this).parent().data("rpid");var b=$(this).attr("href");radioplayer.services.analytics.sendEvent("Search","Autosuggest",a.toString(),null,null);setTimeout(function(){window.location.href=b},100)}).on("mouseenter",".suggest-item",function(){radioplayer.objs.suggestContainer.find(".suggest-item").removeClass("on kb-focus");
$(this).addClass("on")}).on("mouseleave",".suggest-item",function(){$(this).removeClass("on kb-focus")});$("#search-button").on("click",function(a){radioplayer.search.execFull();radioplayer.search.hideNavigationMenu()});$("#search-clear").on("click",function(a){radioplayer.search.resetSearchInput()});$("#search-all-cont, #search-live-cont, #search-od-cont").on("click",".station-group a.station-group-toggle",function(a){a.preventDefault();a=$(this);var b=a.parent().parent(),c=b.attr("data-brand");
if(b.hasClass("collapsed")){b.removeClass("collapsed");var e=radioplayer.lang.search.show_fewer_stations,e=e.replace("{group}",c);a.html("\x3ci\x3e\x3c/i\x3e"+e);$parentContainer=b.parent();radioplayer.overlay.lazyLoad($parentContainer)}else b.addClass("collapsed"),b=radioplayer.lang.search.show_more_stations,b=b.replace("{group}",c),a.html("\x3ci\x3e\x3c/i\x3e"+b)})},execSuggest:function(){var a=$.trim(radioplayer.objs.searchInput.val());regex=/(<([^>]+)>)/ig;var a=a.replace(regex,""),b=radioplayer.lang.search.show_all_results_for.replace("{terms}",
"\x3cstrong\x3e"+a+"\x3c/strong\x3e");$(".suggest-item.show-all a").html(b);clearTimeout(radioplayer.search.suggestQueryDelay);radioplayer.search.suggestQueryDelay=setTimeout(function(){""!=a&&a!=radioplayer.search.lastSuggestQ&&(radioplayer.search.lastSuggestQ=a,radioplayer.services.getAPI(radioplayer.consts.api.suggest+"?query\x3d"+encodeURIComponent(a)+"\x26callback\x3dradioplayer.search.receiveSuggest"))},150)},receiveSuggest:function(a){var b='\x3ch2 class\x3d"access"\x3e'+radioplayer.lang.search.suggested_title+
"\x3c/h2\x3e",c=0;0<a.live.length&&(b+='\x3cdiv class\x3d"suggest-divider"\x3e'+radioplayer.lang.search.suggested_stations+"\x3c/div\x3e",$.each(a.live,function(a,d){b+='\x3cdiv class\x3d"suggest-item'+(d.name?" has-prog-name":"")+'" data-rpid\x3d"'+d.rpId+'"\x3e\x3ca href\x3d"'+d.url+'"\x3e\x3cimg class\x3d"image" src\x3d"'+d.imageUrl+'" alt\x3d"" /\x3e\x3cspan class\x3d"name"\x3e'+d.serviceName+"\x3c/span\x3e"+(d.name?'\x3cspan class\x3d"prog-name"\x3e'+d.name+"\x3c/span\x3e":"")+"\x3c/a\x3e\x3c/div\x3e";
c++}));0<a.onDemand.length&&(b+='\x3cdiv class\x3d"suggest-divider"\x3e'+radioplayer.lang.search.suggested_catch_up+"\x3c/div\x3e",$.each(a.onDemand,function(a,d){b+='\x3cdiv class\x3d"suggest-item has-prog-name" data-rpid\x3d"'+d.rpId+'"\x3e\x3ca href\x3d"'+d.url+'"\x3e\x3cimg class\x3d"image" src\x3d"'+d.imageUrl+'" alt\x3d"" /\x3e\x3cspan class\x3d"name"\x3e'+d.serviceName+'\x3c/span\x3e\x3cspan class\x3d"prog-name"\x3e'+d.name+"\x3c/span\x3e\x3c/a\x3e\x3c/div\x3e";c++}));radioplayer.objs.suggestContainer.data("results",
c);$("#suggest-results").html(b)},resetSearchInput:function(){$("#search-clear").hide();$("#search-button").show();radioplayer.objs.searchBox.removeClass("active");radioplayer.objs.searchInput.val(radioplayer.lang.search.search_radioplayer).disableSelection().focus();radioplayer.utils.setCaretToPos(document.getElementById("search-input"),0)},clearAndCloseSuggestResults:function(){$("#suggest-results").html("");$(".suggest-item.show-all a").html("");radioplayer.search.lastSuggestQ="";radioplayer.overlay.hide();
radioplayer.search.resetSearchInput()},execFull:function(){var a=$.trim(radioplayer.objs.searchInput.val()),a=a.replace(/(<([^>]+)>)/ig,"");if(""!=a&&radioplayer.objs.searchBox.hasClass("active")){radioplayer.objs.body.hasClass("showing-search")||(radioplayer.overlay.show(radioplayer.lang.general.close_search),radioplayer.objs.body.addClass("showing-search"));radioplayer.objs.searchContainer.off();radioplayer.objs.searchContainer.find(".tab-container").html("").removeClass("loaded has-error");$prevSelTab=
$(".search-container .tabs #search-nav-main li.on");$prevSelTab.removeClass("on");$(".search-container .tabs #search-nav-toggle li").eq(0).find("a").html(radioplayer.overlay.getMenuToggleLabel(radioplayer.lang.search.tab_live));radioplayer.overlay.selectTab(radioplayer.objs.searchContainer.find(".tabs #search-nav-main li").eq(0));radioplayer.search.showTabSpinner();radioplayer.consts.is_iOS||radioplayer.objs.searchInput.focus();$("#search-button").hide();$("#search-clear").show();radioplayer.search.requestFailed=
!1;radioplayer.search.requestFailTimer=setTimeout(function(){radioplayer.search.showFailMsg("all")},15E3);var b="?query\x3d"+encodeURIComponent(a)+"\x26rpId\x3d"+currentStationID+"\x26callback\x3dradioplayer.search.receiveall";""!=radioplayer.settings.guid&&(b+="\x26guid\x3d"+radioplayer.settings.guid);radioplayer.services.getAPI(radioplayer.consts.api.search+b);radioplayer.search.q=a}else radioplayer.consts.is_iOS||radioplayer.objs.searchInput.focus()},tabRequest:function(a){this.showTabSpinner();
radioplayer.search.requestFailed=!1;radioplayer.search.requestFailTimer=setTimeout(function(){radioplayer.search.showFailMsg(a)},15E3);var b="?query\x3d"+encodeURIComponent(radioplayer.search.q)+"\x26rpId\x3d"+currentStationID+"\x26callback\x3dradioplayer.search.receive"+a;""!=radioplayer.settings.guid&&(b+="\x26guid\x3d"+radioplayer.settings.guid);radioplayer.services.getAPI(radioplayer.consts.api.search+"/"+a+b)},receiveall:function(a){this.receiveParse("all",a)},receivelive:function(a){this.receiveParse("live",
a)},receiveod:function(a){this.receiveParse("od",a)},showTabSpinner:function(){radioplayer.objs.searchContainer.find(".search-wrapper .spinner").show()},hideTabSpinner:function(){radioplayer.objs.searchContainer.find(".search-wrapper .spinner").hide()},receiveParse:function(a,b){clearTimeout(this.requestFailTimer);if(!this.requestFailed)if("SUCCESS"==b.responseStatus){var c='\x3ch2 class\x3d"access"\x3e'+radioplayer.lang.search["tab_"+a+"_title"]+"\x3c/h2\x3e";0==b.total?(c=this.noResultsMsg(a,radioplayer.search.q),
$("#search-"+a+"-cont").addClass("has-error")):c+=radioplayer.overlay.iterateResults(b.results,"search");this.hideTabSpinner();$("#search-"+a+"-cont").html(c);$("#search-"+a+"-cont").scrollTop(0);radioplayer.overlay.lazyLoad($("#search-"+a+"-cont"))}else this.showFailMsg(a)},noResultsMsg:function(a,b){var c="live"==a?radioplayer.lang.search.no_live_results:"od"==a?radioplayer.lang.search.no_od_results:radioplayer.lang.search.no_all_results,c='\x3cdiv class\x3d"error-message no-results"\x3e'+c.replace("{terms}",
b)+"\x3c/div\x3e";radioplayer.services.analytics.sendEvent("Search","Zero Results",b,null,null);return c},showFailMsg:function(a){this.requestFailed=!0;this.hideTabSpinner();var b='\x3cdiv class\x3d"error-message fail"\x3e'+radioplayer.lang.general.fail_message+"\x3c/div\x3e";$("#search-"+a+"-cont").addClass("has-error").html(b);radioplayer.services.analytics.sendEvent("Errors","Failed Search",currentStationID,null,null)},resetNavigationMenu:function(){$(".search-container .search-wrapper").removeClass("nav-collapsed");
$("#search-nav-main").show();radioplayer.search.hideNavigationMenu()},hideShowNavigationMenu:function(){$("#search-nav-main").is(":visible")?($("#search-nav-main").hide(),$("#search-nav-toggle li a .menu_toggle").removeClass("nav-expanded"),$(".search-container .search-wrapper").addClass("nav-collapsed")):($("#search-nav-main").show(),$("#search-nav-toggle li a .menu_toggle").addClass("nav-expanded"),$(".search-container .search-wrapper").removeClass("nav-collapsed"))},hideNavigationMenu:function(){$("#search-nav-toggle").is(":visible")&&
($("#search-nav-main").hide(),$("#search-nav-toggle li a .menu_toggle").removeClass("nav-expanded"),$(".search-container .search-wrapper").addClass("nav-collapsed"),radioplayer.search.searchNavMenuVisible=!0)}};
radioplayer.lang={general:{radioplayer:"Radioplayer",open_menu:"Radioplayer Menü öffnen",close_menu:"Radioplayer Menü schließen",close_search:"Radioplayer Suche schließen",fail_message:"\x3ch1\x3eEs gibt ein Problem...\x3c/h1\x3e\x3cp\x3e\x3cstrong\x3eEntschuldigen\x3c/strong\x3e Sie die Störung. Bitte prüfen Sie zunächst Ihre Internetverbindung.\x3c/p\x3e\x3cp\x3eSollte das Problem bei uns liegen, dann arbeiten unsere Techniker schon daran. \x3cbr /\x3eBitte versuchen Sie es später nochmal.\x3c/p\x3e",reduced_func_anno:'Mit diesem Browser können Sie leider nicht alle Funktionen des Radioplayers nutzen. \x3ca href\x3d"http://www.radioplayer.de/cookies/" target\x3d"_blank"\x3eÄndern Sie die Cookie-Einstellungen\x3c/a\x3e, oder \x3ca href\x3d"http://www.radioplayer.de/apps" target\x3d"_blank"\x3eladen Sie sich unsere kostenlose App.\x3c/a\x3e',
cookie_anno:'Der Radioplayer verwendet Cookies, um alle Funktionen anbieten zu können.\x3cbr /\x3eWas Cookies sind und wie wir sie verwenden, können Sie \x3ca href\x3d"http://www.radioplayer.de/cookies/" target\x3d"_blank"\x3ehier nachlesen\x3c/a\x3e. Indem Sie den Radioplayer verwenden, erklären Sie sich mit der Nutzung von Cookies einverstanden.',cookie_consent:'Der radioplayer verwendet für seine umfangreichen Funktionen Browser-Cookies. So können Sie zum Beispiel Ihre Senderliste oder die zuletzt gehörten Sender speichern. Mit der Nutzung des radioplayers erklären Sie sich damit einverstanden, dass wir Cookies verwenden. \x3ca href\x3d"http://www.radioplayer.de/cookies/" target\x3d"_blank"\x3eWeitere Informationen\x3c/a\x3e. ',
cookie_consent_dismiss:"OK"},controls:{loading:"Laden...",player_controls:"Player Steuerung",play:"Play",pause:"Pause",stop:"Stopp",mute:"Stumm",unmute:"Stumm aus",set_volume:"Lautstärke",set_volume_20:"Lautstärke 20%",set_volume_40:"Lautstärke 40%",set_volume_60:"Lautstärke 60%",set_volume_80:"Lautstärke 80%",set_volume_100:"Lautstärke 100%",use_device_controls:"Bitte verwenden Sie den Lautstärkeregler an Ihrem Gerät.",press_play_prompt:"Zum Starten\x3cbr\x3ePlay drücken",skip_forward_5_seconds:"5 Sekunden weiter springen",
skip_back_5_seconds:"5 Sekunden zurück springen",skip_forward_30_seconds:"30 Sekunden weiter springen",skip_back_30_seconds:"30 Sekunden zurück springen",skip_forward_1_minute:"1 Minute weiter springen",skip_back_1_minute:"1 Minute zurück springen",skip_forward_5_minutes:"5 Minuten weiter springen",skip_back_5_minutes:"5 Minuten zurück springen",skip_forward_10_minutes:"10 Minuten weiter springen",skip_back_10_minutes:"10 Minuten zurück springen",skip_forward_30_minutes:"30 Minuten weiter springen",
skip_back_30_minutes:"30 Minuten zurück springen"},playing:{live:"Live",live_width:28,format:"{artist} - {track}"},songactions:{buy:"Kaufen",download:"Download",music:"Musik",info:"Information",add:"Hinzufügen",rate:"Bewerten",custom:"custom"},menu_tabs:{tab_1_text:"Meine Sender",tab_1_width:"187px",tab_2_text:"zuletzt gehört",tab_2_width:"187px",tab_3_text:"Empfohlen",tab_3_width:"187px",tab_4_text:"Sender A-Z",tab_4_width:"189px"},recommendations:{locale:"de_DE"},azlist:{alphabet_array:"#abcdefghijklmnopqrstuvwxyz".split(""),
no_stations_beginning:"Hier gibt es noch keine Sender, die mit {letter} beginnen",view_stations_beginning:"Sender anzeigen, die mit {letter} beginnen",a_number:"einer Zahl",no_stations:"Es gibt noch keinen Sender mit diesem Buchstaben"},mystations:{add_this:"Sender zu Meine Sender hinzufügen",remove_this:"Sender aus Meine Sender entfernen",no_items:"\x3ch1\x3eZu Meine Sender hinzufügen\x3c/h1\x3e\x3cp\x3eSie haben noch keine Sender gespeichert.\x3cbr /\x3eKlicken Sie auf das graue Herz bei Ihren Lieblingssendern, um sie hier zu speichern.\x3c/p\x3e"},
search:{search:"Suchen",clear:"Suchfeld löschen",search_radioplayer:"Sender finden",suggested_title:"Empfohlene Suchergebnisse",suggested_stations:"Empfohlene Sender",suggested_catch_up:"Empfohlene Podcasts",show_all_results_for:"Alle Ergebnisse zu {terms} anzeigen",tab_all:"Alle",tab_all_title:"Alle Suchergebnisse",tab_live:"Live",tab_live_title:"Gefundene Live-Programme",tab_catchup:"Mediathek",tab_catchup_title:"Gefundene Podcasts",show_fewer_stations:"Weniger {group} Sender anzeigen",show_more_stations:"Mehr {group} Sender anzeigen",
